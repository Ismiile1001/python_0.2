...
intro = str(" I am Optimus 1.0, I am a programmable artificial intiligence.  \n"
              "Devloped by ismile hossain. under the project of O-ONAI. I wanna give thanks to ismile for devlop me.\n"
...
def sendemail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('ANY MAIL U USED TO ..........', G_p)
    server.sendmail('ANY MAIL TO SEND YOUR MAIL .......', to, content)
    server.close()


dicten = {
    'ismile': 'ismilehossain211@gmail',
    '****': "***********************",
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if "what's the date" in query or "what is the date" in query or "date please"in query or "date" in query:
            date_data()
            print(date_data())
            speek(date_data())
            continue
        ...
        elif "what's the time" in query or "what is the time" in query or "time please" in query or " time " in query:
        ...
        # playing music
            ...
            print('sir, your city is  gazipur ')
            speek('sir, your city is  gazipur ')
            continue

        elif 'my hometown' in query:
            print('sir, your Home town is  gazipur ')
            speek('sir, your Home town is  gazipur ')
            continue
        # convercetion
        # commands for optimus
            ...
            print("Hellow everyone, I am optimus. I am the personal\n "
                  ...
                  'Sir, NOW I am wishing your all off special friends,\n Happy Eid ul Ajha, to, all of you')

            speek("Hellow everyone, I am optimus. I am the personal "
                  "assistent of sir. The Eid festivals is comes  again"
                  " so that sir wishing  all of you. Happy Eid ul Ajha, festival. "
                  'Sir, NOW I am wishing your all off special friends, Happy Eid ul Ajha, to, all of you')
            time.sleep(1)
            ...
            print('Sir, You are Mr. ismile hossain.')
            speek('sir, you are Mr. ismile hossain.')
            ...
            print("I am optimus 0.1")
            speek("I am optimus 0.1")
            continue
        elif 'good' in query:
            print("thanks sir ")
            speek("thanks sir ")
            ...
            print("good morning sir. pleas command me")
            speek("good morning sir. pleas command me")
            ...
            print(
                "actually I dont know. master ismile knows that. master had been  so long on me. but I can tell you, I am younger like master.")
            speek(
                "actually I dont know. master ismile knows that. master had been workin  so long on me. but I can tell you, I am younger like master.")
        ...
        elif "ismile" in query:
            print("he is build me and he is a  intelligent person, more than he is a handsome boy ")    
            speek("he is build me and he is a  intelligent person, more than he is a handsome boy ")    

        elif 'kona' in query or 'khona' in query or 'konta' in query:
